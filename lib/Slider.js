...
updateAnimatedStyles=function(){var _this$state=
_this.state,value=_this$state.value,containerSize=_this$state.containerSize,thumbSize=_this$state.thumbSize;var _this$props=
_this.props,minimumValue=_this$props.minimumValue,maximumValue=_this$props.maximumValue;
...
var minimumTrackWidth=_reactNative.Animated.add(thumbLeft,thumbSize.width/2);

_this.setState({thumbLeft:thumbLeft,minimumTrackWidth:minimumTrackWidth});
},_this.
...
pointerEvents:"none",__source:{fileName:_jsxFileName,lineNumber:514}}));
